...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44327/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44327/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "CaféDroid Sample Application";
        ...
        using (CafeDroid_P3.Logic.ShoppingCartActions myCartOrders = new CafeDroid_P3.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        //from http://stackoverflow.com/questions/34968997/problems-with-paypal-api-http-call
        ...
        {
            // Log the exception.
           CafeDroid_P3.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
